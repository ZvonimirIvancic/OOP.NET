...
namespace DAL.Model
{
    ...
    public partial class StartingEleven
    {
        ...
        [JsonProperty("posishirt_number", NullValueHandling = NullValueHandling.Ignore)]
        public long? PosishirtNumber { get; set; }
    ...
    {
        public static string ToJson(this List<Match> self) => JsonConvert.SerializeObject(self, DAL.Model.Converter.Settings);
    }
